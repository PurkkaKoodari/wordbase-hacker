...
public class GameListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<GameListActivity.LoadResult> {
    ...
    public static final int SHOULD_RESTART = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipe.setOnRefreshListener(() -> reloadData(true));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_SETTINGS && resultCode == SHOULD_RESTART) {
            finish();
            Intent intent = new Intent(this, GameListActivity.class);
            startActivity(intent);
        } else if (requestCode == REQUEST_SETTINGS && resultCode == SHOULD_RELOAD) {
            lastModified = -1;
            reloadData(false);
        }
    }
    ...
    private static class GameListLoader extends AsyncTaskLoader<LoadResult> {
        ...
        GameListLoader(GameListActivity activity, Bundle bundle) {
            ...
            pendingOpponent = activity.getString(R.string.pending_opponent);
            unknownOpponent = activity.getString(R.string.unknown_opponent);
